...
<?php
//display header
$this->template->title = 'Cập nhật thông tin danh mục';
...
<form name="frmMain" method="post" id="frmMain" action=""><?php
    ...
    ?>
    <!-- Toolbar -->
    <h2 class="module_title"><?php echo LANG_UPDATE_LIST_LABEL; ?></h2>
    <!-- /Toolbar -->

    <!-- Cot tuong minh -->
    <div class="Row">
        <div class="left-Col"><?php echo LANG_FILTER_LISTTYPE_LABEL; ?></div>
        <div class="right-Col">
    ...
    <div class="Row">
        <div class="left-Col"><?php echo LANG_LIST_CODE_LABEL; ?></div>
        <div class="right-Col">
    ...
    <div class="Row">
        <div class="left-Col"><?php echo LANG_LIST_NAME_LABEL; ?></div>
        <div class="right-Col">
    ...
    <div class="Row">
        <div class="left-Col"><?php echo _LANG_ORDER_LABEL; ?></div>
        <div class="right-Col">
    ...
    <div class="Row">
        <div class="left-Col"><?php echo _LANG_STATUS_LABEL; ?></div>
        <div class="right-Col">
