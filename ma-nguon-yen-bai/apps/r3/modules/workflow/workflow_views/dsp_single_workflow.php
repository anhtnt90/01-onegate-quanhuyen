    ...
    <div id="procedure">
        <?php if ($v_record_type_code != ''): ?>
            ...
            if (is_file($xml_flow_file_path)):
                ...
                <input type="button" name="btn_edit_workflow" onclick="btn_edit_workflow_onclick(this)" class="button edit" value="Sửa quy trình" />
                <br/><br/>
                <div class="step">
...
<script>
    ...
    {
        var url = '<?php echo $this->get_controller_url('user','cores');?>dsp_all_user_and_group_to_add/&pop_win=1&group=' + group_code;
